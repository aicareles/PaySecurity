...
//        {
//            Object localObject1 = paramBundle.getDataString().split("\\?")[1].split("&");//appid=60009999    url=alipays...257D    sign=58291....76e1
//            Object localObject2 = localObject1[1].split("=");// url    alipays.....257D
//            paramBundle = localObject1[2].split("=");//sign     58291.....76e1
//            localObject1 = localObject1[0].split("=")[1];//appid   60009999
